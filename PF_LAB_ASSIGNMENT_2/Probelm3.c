...
int main()
{
    float root1=0,root2=0; float z[3],disc=0; const int i=-1;
    for (int i = 0; i < 3; i++)
    {
        if(i==0)
        {
    ...
    if (disc>0)
    {
        ...
        root1=((-z[1]+(sqrt(disc))/(2)/(2*z[0])));
        root2=((-z[1]-(sqrt(disc))/(2)/(2*z[0])));    
    ...
    else if (disc<0)
    {
       ...
       root1=((-z[1]+i*(sqrt(disc))/(2)/(2*z[0])));
       root2=((-z[1]-i*(sqrt(disc))/(2)/(2*z[0])));
